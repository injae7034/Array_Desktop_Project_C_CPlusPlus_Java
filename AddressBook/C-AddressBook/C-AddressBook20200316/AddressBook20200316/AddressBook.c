...
/***************************************************************************************************************
 함수명칭: Load
 기능: 디스크파일에 있는 성명, 주소, 전화번호, 이메일주소를 주소록에 기재한다.
 입력: 없음
 출력: 사용량
****************************************************************************************************************/
...
/***************************************************************************************************************
 함수명칭: Save
 기능: 주소록에 있는 성명, 주소, 전화번호, 이메일주소를 디스크 파일에 출력한다.
 입력: 없음
 출력: 사용량
****************************************************************************************************************/
Long Save(AddressBook* addressBook)
{
    ...
    if (file!=NULL)
    {
        ...
        while (index < addressBook->length) 
        {
            //1.1 번호, 성명, 주소, 전화번호, 이메일주소를 출력한다.
            fwrite(addressBook->personals + index, sizeof(Personal), 1, file);
            index++;
        }
        //디스크 파일을 닫는다.
        fclose(file);
